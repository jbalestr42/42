...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2013/12/29 19:21:39 by pciavald          #+#    #+#             */
/*   Updated: 2013/12/31 04:36:51 by jbalestr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		previous(char **envp)
{
	...
	envp = ft_setenv(envp, "PWD", ft_getenv(envp, "OLDPWD"), 0);
	envp = ft_setenv(envp, "OLDPWD", pwd, 0);
	ft_strdel(&pwd);
	return (ret);
}
