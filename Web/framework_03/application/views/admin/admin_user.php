...
<table>
	...
	foreach ($users as $user)
	{
		...
		echo "<td class='actions'>";
			url_icon_get("", "pencil", array('id' => $user->id), "admin/admin_edit_user", lang('pop_edit'));
			url_icon_get("", "remove", array('id' => $user->id), "admin/admin_delete_user", lang('pop_delete'));
			url_icon_get("", "shuffle", array('id' => $user->id), "admin/admin_logas", lang('pop_logas'));
		echo "</td>";
		echo "</tr>";
	} ?>
</table>
