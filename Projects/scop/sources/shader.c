...
t_shader		*create_shader(void)
{
	...
	shader->shaders[0] = load_shader("shaders/default.frag", GL_FRAGMENT_SHADER);
	shader->shaders[1] = load_shader("shaders/default.vert", GL_VERTEX_SHADER);
	...
	shader->uniforms[2] = glGetUniformLocation(shader->program, "ProjectionMatrix");
