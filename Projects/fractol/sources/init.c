...
/*   Updated: 2015/03/05 18:14:11 by jbalestr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		init_fractal_fun(t_env *e)
{
	...
	e->fractal_fun[1] = &mandelbrot;
	e->fractal_fun[2] = &mandelbrot_bof60;
	e->fractal_fun[3] = &mandelbrot_bof61;
	e->fractal_fun[4] = &mandelbrot_broken;
	e->fractal_fun[5] = &mandelbrot_tunnel;
	e->fractal_fun[6] = &burning_ship;
	e->fractal_fun[7] = &newton;
}
