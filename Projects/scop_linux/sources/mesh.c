...
t_mesh			*create_mesh(char const *filename)
{
	...
	glGenBuffers(3, mesh->vertex_buffer_object);
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(t_vertex) * obj_data.vertex_count, obj_data.vertices, GL_STATIC_DRAW);
	glEnableVertexAttribArray(0);
	glVertexAttribPointer(0, 4, GL_FLOAT, GL_FALSE, sizeof(t_vertex), (GLvoid*)0);
	glEnableVertexAttribArray(1);
	glVertexAttribPointer(1, 4, GL_FLOAT, GL_FALSE, sizeof(t_vertex), (GLvoid*)(sizeof(obj_data.obj_vertices[0].position) + sizeof(obj_data.obj_vertices[0].uv)));
	glEnableVertexAttribArray(2);
	glVertexAttribPointer(2, 4, GL_FLOAT, GL_FALSE, sizeof(t_vertex), (GLvoid*)(sizeof(obj_data.obj_vertices[0].position)));
	...
	glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(int) * obj_data.indice_count, obj_data.indices, GL_STATIC_DRAW);
...
void			draw_mesh(t_mesh *mesh)
{
	...
	glDrawElements(GL_TRIANGLES, mesh->indice_count, GL_UNSIGNED_INT, (GLvoid*)0);
