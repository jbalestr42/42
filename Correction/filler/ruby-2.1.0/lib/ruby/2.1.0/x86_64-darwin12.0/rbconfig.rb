...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/mpapis/.rvm/rubies/ruby-2.1.0")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/mpapis/.rvm/rubies/ruby-2.1.0' '--enable-load-relative' '--with-static-linked-ext' '--without-ext=dl/win32,fiddle/win32,tk/tkutil,tk,win32ole,-test-/win32/dln,-test-/win32/fd_setsize' '--sysconfdir=/etc' '--without-tcl' '--without-tk' '--disable-shared' '--with-arch=x86_64' 'CC=/usr/bin/clang' 'CFLAGS=-O3 -I/Users/mpapis/.sm/pkg/active/include -fPIC -mmacosx-version-min=10.6' 'LDFLAGS=-L/Users/mpapis/.sm/pkg/active/lib -L/usr/lib -fPIC -Bstatic'"
  ...
  CONFIG["LDFLAGS"] = "-L. -L/Users/mpapis/.sm/pkg/active/lib -L/usr/lib -fPIC -Bstatic -fstack-protector"
  CONFIG["CFLAGS"] = "-O3 -I/Users/mpapis/.sm/pkg/active/include -fPIC -mmacosx-version-min=10.6 -pipe"
